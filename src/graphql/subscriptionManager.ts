import {PubSub, withFilter as gqlWithFilter} from 'graphql-subscriptions';

// In a production server you might want to have some rabbitMQ, redis or kafka logic here
